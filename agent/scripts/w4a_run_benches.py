...
Output:
    ~/.vmx/reports/alpha_bench_*.html      — per-run HTML reports
    ~/.vmx/reports/bench_<zoo>_<uni>.json  — per-run raw results
    ~/.vmx/reports/bench_summary.json      — aggregate summary
...
REPORTS_DIR = Path.home() / ".vmx" / "reports"
