...
clears the screen and reprints the banner. ``/journal`` and ``/debug``
show a "Coming soon" placeholder pointing at the established
fallback workflows.
"""
...
def cmd_model(ctx: Any = None, *args: str) -> int:  # noqa: ARG001 — ctx unused
    ...
    console.print(
        Text(
            "Run `vmx init` to switch provider, model, or credentials.",
            style="dim",
        )
    )
    return 0
