...
def _env_dir() -> Path: return Path.home() / ".vmx"
...
def _intro_header(console: Console) -> None:
    console.print()
    console.print(Text("  VMaxxing setup", style=Theme.primary))
    console.print(Text(
        "  We didn't find a config at ~/.vmx/.env.\n"
