...
class TestMainRouting:
    ...
    def test_probe_model_name_reads_project_env_candidate(
        ...
        assert cli_main._probe_model_name() == "gpt-5.5"
...
# ---------------------------------------------------------------------------
# /journal /debug behaviour (Parcel I, Bug 4)
# ---------------------------------------------------------------------------


class TestChatCommandsAreActionable:
    """``/journal`` queues a real prompt, not "Coming soon"."""
