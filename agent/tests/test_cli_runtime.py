...
class TestRunnerControlEndpoints:
    ...
    def test_connector_start_message_uses_connector_status(
        ...
        assert "vmx connector status" in out
        assert "vmx live" not in out
...
# ---------------------------------------------------------------------------
# ``vmx resume <session-id>`` dispatches to the interactive loop
# ---------------------------------------------------------------------------


class TestResumeByIdDispatch:
    """``main()`` routes ``vmx resume <session-id>`` to ``_interactive_loop``."""
