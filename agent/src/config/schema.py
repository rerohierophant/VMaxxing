...
ROBINHOOD_AGENT_CONFIG_PATH = "~/.vmx/agent.json"
...
# Canonical seed for the operator-side ``~/.vmx/agent.json`` mcpServers
...
ROBINHOOD_MCP_SERVER_SEED: dict[str, object] = {
    ...
    "auth": {
        "type": "oauth",
        "scopes": ["trading.read"],
        "client_name": "VMaxxing",
        "cache_dir": "~/.vmx/live/robinhood/oauth",
    },
...
class MCPOAuthConfig(ConfigBase):
    ...
    client_name: str = "VMaxxing"
    cache_dir: str = "~/.vmx/live/robinhood/oauth"
