...
This skill exports a VMaxxing strategy to **all major trading platforms** in one go.
...
```pinescript
// This strategy was generated by VMaxxing
...
```mql5
//+------------------------------------------------------------------+
//| Generated by VMaxxing                                         |
//+------------------------------------------------------------------+
#property copyright "VMaxxing"
...
When generating code, map VMaxxing instrument codes appropriately:

| VMaxxing | TradingView | 通达信/同花顺 | MT5 |
|-------------|-------------|---------------|-----|
...
- [ ] Comment header notes the original VMaxxing run_id and instrument
